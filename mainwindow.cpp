...
{
    int lastID = dbUtils.getTotalTenant().toInt();
    ...
    dbUtils.setTenantDetails(ui->tableView);
...
void MainWindow::on_updateEmpButton_clicked()
{
    ...
    deselectedPushButton(ui->addEmpButton);
     ...
     dbUtils.setTenantUpdateDetails(ui->updateTableView);
...
void MainWindow::on_pushButton_5_clicked()
{
    ...
    else
    {
        ...
        {
            sqlQuery->prepare("insert into Tenant (ID, Name, DOB, Gender, Father, Email, Phone, Address, Department, Designation, DOJ, Salary, Type) "
                             "values ('" +
...
void MainWindow::on_pushButton_2_clicked()
{
    ...
    ui->empID->setText(dbUtils.getTenantID(dbUtils.getDepartmentShortName(ui->empDept), dbUtils.getDesignationShortName(ui->empDesig)));
...
void MainWindow::on_deleteEmpButton_clicked()
{
    ...
    dbUtils.setTenantDetails(ui->deleteTableView);
...
void MainWindow::on_tableView_doubleClicked(const QModelIndex &index)
{
    ...
    MainWindow::close();
    TenantInfo* emp = new TenantInfo(this, id);
...
void MainWindow::on_pushButton_7_clicked()
{
    ...
    else
    {
        ...
        if(dbUtils.db.isOpen())
        {
            sqlQuery->prepare("UPDATE Tenant SET "
...
void MainWindow::on_updateTableView_doubleClicked(const QModelIndex &index)
{
     ...
     QSqlQuery* qry = dbUtils.showTenantDetailsToLineEdit(id);
...
void MainWindow::on_searchTextBox_returnPressed()
{
    ...
    dbUtils.searchTenantDetails(ui->tableView, ui->searchTextBox->text().trimmed());
}
